...
set.seed(30)
info_gain_model = train(income ~., data = training_data, method = "rpart", parms = list(split = "gini"), trControl = trctrl, tuneLength = 10)
info_gain_predictor = predict(info_gain_model, newdata = testing_data)
info_gain_CM = confusionMatrix(info_gain_predictor, testing_data$income)
info_gain_CM
```